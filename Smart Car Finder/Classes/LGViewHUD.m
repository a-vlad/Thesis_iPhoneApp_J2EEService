...
static LGViewHUD* defaultHUD = nil;  //default splash for parameter search loading hud
static LGViewHUD* tradeoffHUD = nil; //stores tradeoff and similar car splash 
...
#define kHUDDefaultAlphaValue 0.35
#define kHUDDefaultDisplayDuration 1.5

- (id)initWithFrame:(CGRect)frame bkgColor:(UIColor*)backColor textColor:(UIColor*)textColor bkgAlpha:(float)bkAlpha {
	...
	if (defaultHUD==nil)
		defaultHUD=[[LGViewHUD alloc] initWithFrame:CGRectMake(0, 0, 160, 160) 
                                          ...
                                          textColor:[UIColor whiteColor]
                                           bkgAlpha:kHUDDefaultAlphaValue];
	return defaultHUD;
}

+(LGViewHUD*) tradeoffLoadHUD {
	if (tradeoffHUD==nil)
		tradeoffHUD=[[LGViewHUD alloc] initWithFrame:CGRectMake(0, 0, 220, 240) 
